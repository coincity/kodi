...
##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = '[B][COLOR white]BEM-VINDOS AO [COLOR white][B]VISION PLAY[/COLOR][/B]'
###  DESCRIÇÃO DO ADDON ###############################################################
title_descricao = 'Vision Play Melhor conteudo de filmes e séries para você e toda sua família'
...
#### MENU VIP ################################################################
titulo_vip = '[COLOR white][B]ÁREA VIP - VISION PLAY[/B][/COLOR] [COLOR gold][B](VIP)[/B][/COLOR]'
...
url_b64_principal = 'aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2ZpbmktdXgvaG9ydXNfdGVhbS9tYWluL0NhdGVnb3JpYXM='
